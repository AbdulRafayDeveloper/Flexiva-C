                ...
                <div class="modal-dialog modal-xl">
                  <div class="modal-content">
                    ...
                    <div class="modal-header">
                      {/* <!-- <h4 class="modal-title">Flexiva Membership Program Terms and Conditions</h4> --> */}
                      <button
                        type="button"
                        class="btn-close"
                    ...
                    <div class="modal-body model_text">
                      <h3>Flexiva Membership Program Terms and Conditions</h3>
                      <p>
                      ...
                      <p class="main_text_m">
                        {" "}
                        By enrolling in Flexiva Membership Program, you
              ...
              <div class="modal" id="myModal1">
                <div class="modal-dialog modal-xl">
                  <div class="modal-content">
                    ...
                    {/* <!-- Modal body --> */}
                    <div class="modal-body model_text">
                      <h3>Flexiva Cancellation Policy</h3>
                      <p>
