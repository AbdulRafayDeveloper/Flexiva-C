    ...
    <>
            ...
            <div class="row pt-5 pb-5">
              <div class="col-lg-5 col-md-8 col-sm-12">
                <div class="massage_text provider_text">
                  <h1>
                    Join Our Team: Work with <span>Flexiva</span>{" "}
                  </h1>
        ...
        <div class="massage_banner_bg">
          <div class="container">
            <p class="massage_banner_text">
              At Flexiva, we believe that the heart of our success lies in our
        ...
        <div class="row m-0">
          <div class="col-lg-6 col-md-12 col-sm-12 p-0">
            <div class="provider_detail">
              <h1>
                Empower Your Earnings: Join Flexiva for the Best in the Industry
              </h1>
              <p>
                At Flexiva, we believe you should be in control of what you
                earn. That's why we offer a payment structure that's unmatched
                in the industry. Here's why joining Flexiva means unlocking your
                ...
                <div class="mem_Sec_text ">
                  ...
                  <div class="empower_list_d pt-3">
                    ...
                    <div class="empower_list_text ">
                      ...
                      <p className="pp">
                        With Flexiva, there are no surprises. You'll see exactly
        ...
        >
          <div class="container">
            <h1 class="stretchinf_bn_text m-0">
              Explore opportunities throughout Flexiva
            </h1>
          </div>
        </div>
      </div>
      ...
      <div class="hero-container">
        <div class="row m-0 py-5">
          <div class="safty_h">
            <h1>Flexiva’s Commitment to Safety</h1>
            <p>
              At Flexiva, your health and safety are paramount. We've
                  ...
                  <div class="empower_list_d pt-3">
                    <div class="empower_list_text ">
                      ...
                      <p>
                        ...
                        patient violations of Flexiva’s Terms of Use.
                      </p>
                    </div>
                  </div>
                  <div class="empower_list_d pt-3">
        ...
        >
          <div class="container">
            <p class="massage_banner_text pp" >
              With Flexiva, you're in safe hands. Our comprehensive safety
        ...
        <div class="row  ms-0 me-0">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 p-0">
            <div class="provider_type_text">
              <p>
                At Flexiva, we're not just offering jobs; we're offering careers
                that allow you to thrive, grow, and make a meaningful impact.
                Join us in shaping the future of Flexiva and be part of a team
                ...
                team. We look forward to welcoming you to the Flexiva family.
              </p>
              <a href="/join-program">
