        ...
        <div class="massage_banner_bg">
          <div class="container">
            <p class="massage_banner_text">
              At Flexiva, we believe that collaboration is the cornerstone of
          ...
          <div class="col-lg-6 p-0">
            <div class="buss_f_text">
              ...
              <p>
                ...
                Flexiva’s on-demand massage services. Our team of fully
          ...
          <div class="col-lg-6 p-0">
            <div class="buss_f_text">
              ...
              <p>
                ...
                Partner with Flexiva and embark on a journey of innovation,
      ...
      <div class="container-fluid p-0">
        <div class="row m-0 pt-5">
          ...
          <div class="col-lg-6 p-0">
            <div class="buss_f_text">
              <h3>
                Discover why owning a Flexiva franchise is the key to your
