...
export default function UserHeader() {
  return (
    <>
      <Helmet>
        ...
        <title>Dashboard - Flexiva</title>

        <meta name="description" content="" />
        <meta name="author" content="Pro Nauman" />
        <link rel="shortcut icon" href="/img/favicon.png" />
        <link
          rel="stylesheet"
          href="/user/assets/fonts/bootstrap/bootstrap-icons.css"
        />
        <link rel="stylesheet" href="/user/assets/css/main.min.css" />

        <link
          rel="stylesheet"
          href="/user/assets/vendor/overlay-scroll/OverlayScrollbars.min.css"
        />

        <link
          rel="stylesheet"
          href="/user/assets/vendor/calendar/css/main.min.css"
        />
        <link
          rel="stylesheet"
          href="/user/assets/vendor/calendar/css/custom.css"
        />
      </Helmet>
  ...
  <div className="app-header d-flex align-items-center">
    ...
    <div className="d-flex col">
      <button className="toggle-sidebar text-dark" id="toggle-sidebar">
        <i className="bi bi-list lh-1 text-dark" />
      </button>
    ...
    {/* Toggle buttons end */}
    {/* App brand starts */}
    <div className="app-brand py-2 col">
      <a href="/dashboard">
        <div className="logo">
          <svg
            width={238}
    ...
    <div className="header-actions col">
      <div className="d-lg-flex d-none align-items-center gap-2">
        <div className="dropdown">
          <a
            className="dropdown-toggle header-action-icon text-dark"
            href="#!"
            role="button"
            data-bs-toggle="dropdown"
            aria-expanded="false"
          >
            <i className="bi bi-exclamation-triangle fs-5 lh-1 text-dark" />
            <span className="count-label">7</span>
          </a>
          <div className="dropdown-menu dropdown-menu-end shadow-lg">
            <h5 className="fw-semibold px-3 py-2 text-dark">Notifications</h5>
            <div className="dropdown-item">
              <div className="d-flex py-2 border-bottom">
                <div className="icon-box md bg-success rounded-circle me-3">
                  <i className="bi bi-exclamation-triangle text-dark fs-4" />
                </div>
                <div className="m-0">
                  <h6 className="mb-1 fw-semibold">Rosalie Deleon</h6>
                  <p className="mb-1 text-secondary">You have new order.</p>
            ...
            <div className="dropdown-item">
              <div className="d-flex py-2 border-bottom">
                <div className="icon-box md bg-danger rounded-circle me-3">
                  <i className="bi bi-exclamation-octagon text-dark fs-4" />
                </div>
                <div className="m-0">
                  <h6 className="mb-1 fw-semibold">Donovan Stuart</h6>
                  <p className="mb-2">Membership has been expired.</p>
            ...
            <div className="dropdown-item">
              <div className="d-flex py-2">
                <div className="icon-box md bg-warning rounded-circle me-3">
                  <i className="bi bi-exclamation-square text-dark fs-4" />
                </div>
                <div className="m-0">
                  <h6 className="mb-1 fw-semibold">Roscoe Richards</h6>
                  <p className="mb-2">Payment pending. Pay now.</p>
        ...
        <div className="dropdown">
          <a
            ...
            aria-expanded="false"
          >
            <i className="bi bi-bell fs-5 lh-1 text-dark" />
          </a>
          <div className="dropdown-menu dropdown-menu-end shadow-lg">
            <h5 className="fw-semibold px-3 py-2 text-primary">Updates</h5>
            <div className="dropdown-item">
              <div className="d-flex py-2 border-bottom">
                <div className="icon-box md border border-success grd-success-light rounded-circle me-3">
                  <span className="text-success">DS</span>
                </div>
                <div className="m-0">
            ...
            <div className="dropdown-item">
              <div className="d-flex py-2 border-bottom">
                <div className="icon-box md border border-danger grd-danger-light rounded-circle me-3">
                  <span className="text-danger">WG</span>
                </div>
                <div className="m-0">
            ...
            <div className="dropdown-item">
              <div className="d-flex py-2">
                <div className="icon-box md border border-warning grd-warning-light rounded-circle me-3">
                  <span className="text-warning">TJ</span>
                </div>
                <div className="m-0">
      ...
      <div className="dropdown ms-3">
        ...
        >
          <img
            src="/user/assets/images/user2.png"
            className="rounded-2 img-3x"
            alt="Bootstrap Gallery"
          />
          <div className="ms-2 text-truncate d-lg-block d-none text-dark">
        ...
        <div className="dropdown-menu dropdown-menu-end shadow-lg">
          <div className="header-action-links">
            <a className="dropdown-item" href="/settings">
              <i className="bi bi-person border border-primary text-primary" />
              Profile
            </a>
            <a className="dropdown-item" href="/settings">
              <i className="bi bi-gear border border-danger text-danger" />
              Settings
            </a>
          </div>
