            ...
            <div className="row mt-3">
              <div className="col-md-8 col-sm-8 text-left">
                <ul className="list-unstyled">
                  <li>
                    <strong>Invoice #:</strong> FLX4544
                  </li>
                  <li>
                    <strong>Order #:</strong> #00346
                  </li>
                  <li>
                    <strong>Nature of Transaction:</strong> Paytm
                  </li>
                  <li>
                    <strong>Place of Service:</strong> Muzaffarpur, Bihar
                  </li>
                </ul>
              </div>
              <div className="col-md-4 col-sm-4">
                <ul className="list-unstyled ">
                  <li>
                    <strong>Order Date:</strong> 09-10-2023
                  </li>
                  <li>
                    <strong>Imnvoice Date:</strong> 09-10-2023
                  </li>
                  <li>
                    <strong>Nature of Service:</strong> XXXXX
                  </li>
                  <li>
                    <strong>State Country Code #:</strong> XXXXX
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-sm-12 col-12">
            <div className="row mt-3">
              <div className="col-md-8 col-sm-8 text-left">
                <ul className="list-unstyled">
                  <li>
                    <strong>Service To :</strong> Alia Williams
                  </li>
                  <li>
                    <strong>Address:</strong> House # 152/D Muzafarpur,Bihar
                  </li>
                  <li>
              ...
              <div className="col-md-4 col-sm-4">
                <ul className="list-unstyled ">
                  ...
                  <li>
                    <strong>Address:</strong> Muzafarpur, Bihar
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="table-responsive">
                ...
                <table className="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <h6>Massage, Stretch</h6>
                        <p>Complete Service for Muscle and Body Relaxing</p>
                        <p>
                          Provider Assigned: <b>Provider 1</b>
                        </p>
                        <p>
                          BodyGuard Assigned: <b>BodyGuard 1</b>
                        </p>
                      </td>
                      <td>
                        <h6>1800.00</h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <h5 className="text-blue">1800.00</h5>
                      </td>
                      <td>
                        <h5 className="text-blue">0.00</h5>
                      </td>
                      <td>
                        <h5 className="text-blue">2316.00</h5>
                      </td>
                    </tr>
                    <tr>
                      <td colSpan={10}>
