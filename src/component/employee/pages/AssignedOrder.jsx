                  ...
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                      ...
                      <div className="card-body">
                        ...
                        <p className="card-text">Location: 123 Main St, City</p>
                      </div>
                    </div> */}
                        <div className="card mb-4">
                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span className="btn btn-success">
                          On going <br /> Time Left 00:35:56
                        </span>
                      </td>
                      <td>
                        <div className="row m-1">
                    ...
                    <tr>
                      ...
                      <td>INR 5690</td>
                      <td>
                        <span className="btn btn-success">Finished</span>
                      </td>
                      <td>
                        <div className="row m-1">
                          <button
